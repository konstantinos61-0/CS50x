...
This week covers the following core topics: abstract data structures as forms of organization of data in memory, stacks, queues, linked lists, trees, hashing, hash tables and tries. 
### Inheritance
